...
// 定义一个独立于平台的不区分大小写的ASCII字符串比较函数
// ./PlatformAndroid.cpp ./PlatformLinux.cpp
// ./PlatformWindows.cpp
// ./PlatformiOS.mm ./PlatformMacOSX.mm
...
#define VERTEX_ATTRIBUTE_TANGENT_NAME               "a_tangent"         // 切线
#define VERTEX_ATTRIBUTE_BINORMAL_NAME              "a_binormal"        // 副法线
 ...
 * function calls.
 * 
 * 在release版该变量do nothing，因此它是可以安全地用于实时/每帧GL函数调用
 */
